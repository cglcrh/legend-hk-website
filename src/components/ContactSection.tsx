          ...
          >
            ...
            <div className="p-5 rounded-xl bg-gradient-to-br from-purple-500/5 to-blue-500/5 border border-purple-500/20">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-white font-semibold">{t.quickTitle}</span>
              </div>
            ...
            <form onSubmit={handleSubmit} className="p-6 sm:p-8 rounded-2xl bg-white/[0.03] border border-[rgba(148,163,184,0.1)] backdrop-blur-sm">
              {isSubmitted ? (
                ...
                >
                  ...
                  <h3 className="text-xl font-bold text-white mb-2">{t.formSuccessTitle}</h3>
                  <p className="text-[#94a3b8]">{t.formSuccessDesc}</p>
                </motion.div>
              ) : (
                <>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                    <div>
                      <label className="block text-sm text-[#94a3b8] mb-2">{t.fields.name} *</label>
                      <input
                        type="text"
                        name="name"
                        required
                    ...
                    <div>
                      <label className="block text-sm text-[#94a3b8] mb-2">{t.fields.company}</label>
                      <input
                        type="text"
                        name="company"
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                    <div>
                      <label className="block text-sm text-[#94a3b8] mb-2">{t.fields.email} *</label>
                      <input
                        type="email"
                        name="email"
                        required
                    ...
                    <div>
                      <label className="block text-sm text-[#94a3b8] mb-2">{t.fields.phone}</label>
                      <input
                        type="tel"
                        name="phone"
                  ...
                  <div className="mb-4">
                    <label className="block text-sm text-[#94a3b8] mb-2">{t.fields.industry}</label>
                    <select
                      name="industry"
                  ...
                  <div className="mb-6">
                    <label className="block text-sm text-[#94a3b8] mb-2">{t.fields.message}</label>
                    <textarea
                      name="message"
                      rows={4}
